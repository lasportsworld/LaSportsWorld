    ...
    <section className="relative overflow-hidden bg-white py-14 lg:py-16">
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="mb-9 text-center">
          <p className="mb-2 text-xs font-extrabold uppercase tracking-[0.2em] text-gold">How It Works</p>
        ...
        <div className="relative grid gap-5 md:grid-cols-3">
          ...
          {steps.map((step) => (
            <div key={step.num} className="relative flex items-center gap-4 rounded-lg bg-cream p-5 shadow-sm">
              ...
              <div>
                <h3 className="text-xs font-extrabold uppercase tracking-wide text-navy">{step.title}</h3>
                <p className="mt-1 text-xs leading-5 text-navy/60">{step.description}</p>
              </div>
            </div>
          ))}
        </div>
